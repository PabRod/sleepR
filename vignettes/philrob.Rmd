...
philrobPlot(sol_paper)
rasterPlot(sol_paper)
```
...
```{r 000, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 001, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 010, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 011, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 100, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 101, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 110, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
...
```{r 111, include = TRUE, echo = FALSE, fig.show='hold', fig.height = 3}
## Problem setting
y0 <- c(Vv = -13, Vm = 1, H = 10) # Initial conditions
